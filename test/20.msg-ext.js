...
describe(TITLE, function () {
    ...
    it("255 bytes", function () {
        ...
        buffer[0] = 8;
        var packed = new __1.MsgExt(buffer, 7).toMsgpack();
    ...
    it("256 bytes", function () {
        ...
        buffer[0] = 10;
        var packed = new __1.MsgExt(buffer, 9).toMsgpack();
    ...
    it("65535 bytes", function () {
        ...
        buffer[0] = 12;
        var packed = new __1.MsgExt(buffer, 11).toMsgpack();
    ...
    it("65536 bytes", function () {
        ...
        buffer[0] = 14;
        var packed = new __1.MsgExt(buffer, 13).toMsgpack();
